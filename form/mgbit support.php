...
<body>
   ...
   <div class="note">
      <p class="note-title">&nbsp&nbsp Technical Support</p>
      <br>
      <p class="note-description">The issues and events you encounter.</p>
   </div>

   <div class="description">
      <p>Description of your encounter, software or hardware.</p>
      <br> <input placeholder="Your answer" type="text" name="software_hardware_description">
   </div>

   <div class="screenshot">
      <p>Screenshot of the described issue<font color="red">*</font></p>
      <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
      <button type="button" class="btndesign"><font color="#3488ef">
         <i class="fa fa-upload"></i> Add File</font></button>
   ...
   <div class="btn">
    <div class="btna"><button type = "button" onclick="history.back()">
     <font color="#673ab7">Back</font></button></div>

     <div class="btnb"> <button type = "submit">
